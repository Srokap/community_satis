...
return array(
	'community_satis:settings:satispath' => 'Path to write the output satis.json file',
	'community_satis:action:generate:success' => 'Successfully regenerated satis.json',
